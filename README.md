...
- **Unique clones, latest 14-day GitHub traffic window:** 49+
- **Estimated annual usage events:** ~1274
- **Tracked repositories:** 7
- **Last updated:** 2026-07-20

Repository breakdown:

- `3D-TSV`: 7 unique clones / 14 days
- `TOP3D_XL`: 11 unique clones / 14 days
- `SGLDBench`: 15 unique clones / 14 days
