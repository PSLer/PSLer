...
- **Unique clones, latest 14-day GitHub traffic window:** 71+
- **Estimated annual usage events:** ~1846
- **Tracked repositories:** 7
- **Last updated:** 2026-09-21

Repository breakdown:

- `3D-TSV`: 15 unique clones / 14 days
- `TOP3D_XL`: 8 unique clones / 14 days
- `SGLDBench`: 11 unique clones / 14 days
- `PSLshell`: 3 unique clones / 14 days
- `Infill_plus`: 7 unique clones / 14 days
- `TopRank3`: 13 unique clones / 14 days
- `MiniFEM`: 14 unique clones / 14 days
