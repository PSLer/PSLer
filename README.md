...
- **Unique clones, latest 14-day GitHub traffic window:** 24+
- **Estimated annual usage events:** ~624
...
- `SGLDBench`: 4 unique clones / 14 days
- `PSLshell`: 4 unique clones / 14 days
- `Infill_plus`: 2 unique clones / 14 days
- `TopRank3`: 4 unique clones / 14 days
- `MiniFEM`: 1 unique clones / 14 days
