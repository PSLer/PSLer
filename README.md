...
- `3D-TSV`: 14 unique clones / 14 days
- `TOP3D_XL`: 13 unique clones / 14 days
- `SGLDBench`: 14 unique clones / 14 days
- `PSLshell`: 5 unique clones / 14 days
- `Infill_plus`: 7 unique clones / 14 days
- `TopRank3`: 8 unique clones / 14 days
- `MiniFEM`: 10 unique clones / 14 days
