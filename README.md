...
- **Unique clones, latest 14-day GitHub traffic window:** 55+
- **Estimated annual usage events:** ~1430
- **Tracked repositories:** 7
- **Last updated:** 2026-08-03

Repository breakdown:

- `3D-TSV`: 12 unique clones / 14 days
- `TOP3D_XL`: 8 unique clones / 14 days
- `SGLDBench`: 21 unique clones / 14 days
- `PSLshell`: 2 unique clones / 14 days
- `Infill_plus`: 4 unique clones / 14 days
- `TopRank3`: 3 unique clones / 14 days
- `MiniFEM`: 5 unique clones / 14 days
